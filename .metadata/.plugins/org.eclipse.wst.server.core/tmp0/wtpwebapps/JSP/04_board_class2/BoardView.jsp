<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="mybatis.board.service.*, mybatis.board.model.*" %>
<% 
...
%>    
	<jsp:useBean id="board" class='mybatis.board.model.Comment'>
...
<body>
	...
	<tr>
		<td colspan="2">
			...
			<a href='BoardModify.jsp?articleId=<%=articleId %>' >수정하기</a>
			<a href='BoardDelete.jsp?articleId=<%=articleId %>' >삭제하기</a>	
		</td>
	</tr>
	</table>
